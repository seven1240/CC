...
#ifndef _NODE_JSONGET_H_
#define _NODE_JSONGET_H_

#include "node_base.h"

class NodeJsonGet : public NodeBase {
public:
    NodeJsonGet(const uint32_t id, const string& name,
                const string& type, const string& desc, const key_map_t& keymap);
    virtual ~NodeJsonGet(void);
